...
vacMsg = Label(root, text="At this day, this many people will be fully vaccinated: ").grid(row=13, column=0)
vacInput = Label(root, text=numOfVacPeople).grid(row=13, column=1)
